...
default_parameters = {'path_to_save': str(Path.home()),'dlc_config_paths':[], 'rotations':{}, 'exposures': {}, 'parameters':{'exposure':-5,'resWidth':640,'resHeight':480,'framerate':25,'codec':'DIVX'}, 'blenderEXEpath':None}
